...
Continuous learning is the task of mitigating a neural network's tendency to discard previously learnt knowledge while learning a new task. Few-shot learning deals with acquiring maximal knowledge from limited samples in a problem domain. We explore the combination of these two tasks -- Few-Shot Continuous Learning (FSCL) -- and present a novel meta learning solution which rapidly re-parametrises a neural network such that it performs well on both the original, and new tasks. We show that our Meta-Learner performs well on a public dataset, obtaining results of $\sim$3x that of a standard transfer-learning solution.
...
\begin{enumerate}
	\item Introduced the new important task of Few-Shot Continuous Learning (FSCL). The FSCL problem has not been previously identified in the literature yet it is a task that humans perform everyday.
...
For comparison in each of the following experiments, we describe a \textbf{Baseline Transfer Learning} procedure, which is performed in the following manner:
\begin{enumerate}
...
\begin{table}[h] \label{tab:blocks-scores}
	...
	\begin{tabular}{|l|l|l|l|l|l|l|}
		...
		\begin{tabular}{@{}l@{}}Baseline \\ Transfer Learning\end{tabular} & -- & -- & 0.044 & 0.406 & 0.045 & 0.406 \\ \hhline{|=|=|=|=|=|=|=|}
...
\begin{table}[h!] 
	...
	\begin{tabular}{|l|l|l|l|l|l|l|}
		\hline
		\begin{tabular}{@{}l@{}}Meta-Learner \\ Inputs\end{tabular}  & Initialisation & 		\begin{tabular}{@{}l@{}}Meta-Learner \\ Outputs\end{tabular} & \begin{tabular}{@{}l@{}}Source \\ Precision\end{tabular} & \begin{tabular}{@{}l@{}}Target \\ Precision\end{tabular} & Retention      & Acquisition    \\ \hhline{|=|=|=|=|=|=|=|}
		\begin{tabular}{@{}l@{}}Baseline \\ Transfer Learning\end{tabular} & -- & -- & 0.003 & 0.300 & 0.004 & 0.383 \\ \hhline{|=|=|=|=|=|=|=|}
